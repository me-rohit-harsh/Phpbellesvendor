    ...
    if (Platform.OS === 'android') {
      ...
      if (apiLevel >= 33 && source !== 'camera') {
        try {
          ...
          // Extract file information from the content URI
          const uri = result.data;
          const fileName = `image_${Date.now()}.jpg`;
          
          // Determine file type from URI if possible
          ...
          console.info('🤖 Android Photo Picker selected image:', { uri, type: fileType, name: fileName });
