...
export const testConnectivity = async () => {
  try {
    ...
    console.info('🔄 Attempting alternative connectivity test...');
    try {
      ...
      console.info('🌐 Base domain reachable:', baseTest.status);
    } catch (baseError) {
