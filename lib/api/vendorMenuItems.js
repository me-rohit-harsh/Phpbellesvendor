...
export const updateMenuItem = async (itemId, itemData) => {
  try {
    ...
    if (hasNewImage) {
      ...
      // Fix: Send both keys to ensure backend compatibility
      if (itemData.menu_category_id || itemData.category_id || itemData.category) {
        const catId = (itemData.menu_category_id || itemData.category_id || itemData.category).toString();
        formData.append('menu_category_id', catId);
