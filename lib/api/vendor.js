...
export const createMenuItem = async (itemData) => {
  try {
    ...
    // Validate image file if provided (now optional for testing)
    const imageFile = itemData.image;
    
    // Only validate image format if an image is provided
    if (imageFile) {
    ...
    if (imageFile) {
      ...
      console.log('No image provided - creating menu item without image');
    }
