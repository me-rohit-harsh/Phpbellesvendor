...
export const registerVendor = async (vendorData) => {
  const makeRegistrationRequest = async () => {
    ...
    if (vendorData.latitude != null) {
      formData.append('latitude', String(vendorData.latitude));
    }
    if (vendorData.longitude != null) {
      formData.append('longitude', String(vendorData.longitude));
    }
...
export const getVendorProfile = async () => {
  try {
    logRequestDetails('Fetching vendor profile', '/vendor/profile');
